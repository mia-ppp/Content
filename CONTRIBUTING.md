...
Thanks for your interest in contributing to Writing Skills! This guide will help you add new skills or improve existing ones.

## Requesting a Skill

You can suggest new skills by [opening a skill request](https://github.com/mia-ppp/Content/issues/new?template=skill-request.yml).
...
- **Directory name**: lowercase, hyphens only (e.g., `copy-editing`, `tone-checker`)
...
- Add before/after examples of input and output
- Cover common edge cases
- No em dashes anywhere in the skill file
- No sentence should span more than 2 lines in examples
...
- [ ] Before/after examples included where relevant
- [ ] No sensitive data or credentials
- [ ] No em dashes in the skill file
- [ ] No sentence in examples spans more than 2 lines
